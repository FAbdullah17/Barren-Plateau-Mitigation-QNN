#!/usr/bin/env python
"""
Run all 4-layer experiments (3 approaches × seed-triple indices).

Executes baseline, layerwise, and local cost training at 4-layer depth across
...
Usage:
    ...
    python scripts/run_4layer_experiments.py --seed-indices 0 1 2
"""
...
EXPERIMENTS = [
    ('baseline', 'configs/baseline_4layer.yaml'),
    ('layerwise', 'configs/layerwise_4layer.yaml'),
    ('local_cost', 'configs/local_cost_4layer.yaml'),
]
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run all 4-layer experiments')
    parser.add_argument(
    ...
    print("\n" + "=" * 70)
    print("4-LAYER EXPERIMENTS COMPLETE")
    print("=" * 70)
